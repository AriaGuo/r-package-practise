...
The first function **string_bind**is to bind two string characters into one string with ethier unique values (defaults) or duplicated values . Based on the unit test result, this function works on any characters but with some exception. See notation in testthat.R for detail.
